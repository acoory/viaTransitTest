...
export default function LocationSection({ booking }: { booking: Booking }) {
  const formatDateBooking = (start: string, end: string) => {
  ...
  return (
    <View style={{ paddingHorizontal: 16, paddingTop: 12, gap: 4 }}>
      <Text style={{ fontFamily: "Graphik-Medium", fontSize: 18 }}>{booking.city}</Text>
      <View
        style={{
      ...
      >
        ...
        >
          <Image source={{ uri: booking.bookingImage }} style={{ width: "100%", height: 200, borderRadius: 16, marginBottom: 8 }} />
          <View style={{ gap: 4, paddingTop: 10, paddingHorizontal: 10 }}>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
              ...
              <Pressable style={{ backgroundColor: "#f0f0f0", paddingVertical: 20, paddingHorizontal: 30, borderRadius: 12 }}>
                <Text style={{ fontFamily: "Graphik-Medium", fontSize: 15, textAlign: "left" }}> {"Afficher\nl'annonce"}</Text>
              </Pressable>
            </View>
          </View>
        </View>
